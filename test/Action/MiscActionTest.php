...
/**
 * @covers \App\Action\MiscAction
 */
final class MiscActionTest extends TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->action = new MiscAction($this->renderer);
    }

    public function testActionRendersTemplate() : void
    {
        $content = uniqid('content', true);
        $this->renderer->expects(self::once())->method('render')->with('app::misc')->willReturn($content);
